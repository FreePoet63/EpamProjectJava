...
import static com.epam.company.optional1task.NumbersMinimumNumberDifferentDigits.displayNamberDifferentDigits;

public class Optional1Task {
    public static void main(String[] args) {
        displayNamberDifferentDigits();
        setNumberLength();
        setEvenOddDigits();
        setLongShortNum();
    }
